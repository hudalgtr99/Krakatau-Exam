...
class XMLQuestionImporter
{
    ...
    private function addSubject()
    {
		...
		echo '<div class="border border-info alert alert-info"><p>Untuk melihat hasil import bank soal <strong>'.$this->level_data['module']['module_name'].'</strong> dengan topik <strong>'.$this->level_data['subject']['subject_name'].'</strong>, silakan tekan tombol <u>Buka Bank Soal</u> di bawah ini<br/></p><a class="btn btn-outline-info btn-sm" href="tce_show_all_questions.php?order_field=question_enabled+DESC%2C+question_position%2C+question_description&subject_module_id='.$this->level_data['module']['module_id'].'&subject_id='.$this->level_data['subject']['subject_id'].'&submitted=1&firstrow=0"><i class="pe-7s-news-paper"></i> Buka Bank Soal</a></div>';
    }
