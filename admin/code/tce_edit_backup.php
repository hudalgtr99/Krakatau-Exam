...
// $thispage_title_icon = '<i class="pe-7s-box1 icon-gradient bg-strong-bliss"></i> ';
// $thispage_help = $l['hp_edit_backups'];
...
// echo '<label class="input-group-text" for="backup_file">'.$l['w_backup_file'].'</label>'.K_NEWLINE;
// echo '</div>'.K_NEWLINE;
// // echo '<span class="formw">'.K_NEWLINE;
// echo '<select class="form-control" name="backup_file" id="backup_file" size="0">'.K_NEWLINE;
...
// echo '</div>'.K_NEWLINE;
// echo '<div class="rowlll card-footer">'.K_NEWLINE;

// F_submit_button_alt('backup', $l['w_backup'], $l['h_backup'], 'btn btn-success m-1');
// F_submit_button_alt('restore', $l['w_restore'], $l['h_restore'], 'btn btn-primary m-1');
// if (K_DOWNLOAD_BACKUPS) {
//     F_submit_button_alt('download', $l['w_download'], $l['h_download'], 'btn btn-alternate m-1');
// }
