 ...
 * Operator level.
 */
define('K_AUTH_SUPERVISOR', 5);

/**
 * Operator level.
 */
define('K_AUTH_TEACHER', 6);

/**
 * Required user's level to access index page.
 */
define('K_AUTH_INDEX', K_AUTH_SUPERVISOR);
 ...
 */
define('K_AUTH_ADMIN_TCECODE', K_AUTH_TEACHER);

/**
 * Required user's level to access "module editor".
 */
define('K_AUTH_ADMIN_MODULES', K_AUTH_TEACHER);

/**
 * Required user's level to access "subject editor".
 */
define('K_AUTH_ADMIN_SUBJECTS', K_AUTH_TEACHER);

/**
 * Required user's level to access "question editor".
 */
define('K_AUTH_ADMIN_QUESTIONS', K_AUTH_TEACHER);

/**
 * Required user's level to access "answer editor".
 */
define('K_AUTH_ADMIN_ANSWERS', K_AUTH_TEACHER);

/**
 * Required user's level to access "test editor".
 */
define('K_AUTH_ADMIN_TESTS', K_AUTH_TEACHER);
 ...
 */
define('K_AUTH_ADMIN_ONLINE_USERS', K_AUTH_TEACHER);

/**
 * Required user's level to upload images.
 */
define('K_AUTH_ADMIN_UPLOAD_IMAGES', K_AUTH_TEACHER);

/**
 * Required user's level to manually rate free text answers.
 */
define('K_AUTH_ADMIN_RATING', K_AUTH_TEACHER);

/**
 * Required user's level to display results.
 */
define('K_AUTH_ADMIN_RESULTS', K_AUTH_TEACHER);
 ...
 */
define('K_AUTH_ADMIN_OMR_IMPORT', K_AUTH_TEACHER);
 ...
 */
define('K_AUTH_ADMIN_FILEMANAGER', K_AUTH_TEACHER);

/**
 * Required user's level to create and delete directories.
 */
define('K_AUTH_ADMIN_DIRS', K_AUTH_TEACHER);

/**
 * Required user's level to delete multimedia files.
 */
define('K_AUTH_DELETE_MEDIAFILE', K_AUTH_TEACHER);

/**
 * Required user's level to rename multimedia files.
 */
define('K_AUTH_RENAME_MEDIAFILE', K_AUTH_TEACHER);

/**
 * Required user's level to edit SSL certificates.
 */
define('K_AUTH_ADMIN_SSLCERT', K_AUTH_TEACHER);
