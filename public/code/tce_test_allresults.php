...
<div class="alert alert-info"><h4>Menu ini hanya dapat digunakan oleh admin</h4><p>Masuk ke menu admin jika Anda adalah seorang admin, jika bukan mintalah Admin untuk mengeceknya</p></div>
<?php
