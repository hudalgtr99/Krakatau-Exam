...
$thispage_title_icon = '<span class="icon-mail"></span>';
...
echo getFormRowTextInputIcon('currentpassword', $l['w_password'], $l['h_password'].'" class="lh2 d-iblock', '', '', '', 255, false, false, true, '', 'pos-rel', '<span class="icon mailpwdicon icon-eye" id="showPass"></span><span class="icon mailpwdicon icon-eye-blocked" id="hidePass"></span>');
